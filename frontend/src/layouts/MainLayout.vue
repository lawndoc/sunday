  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar>
        ...
        <div class="q-gutter-sm row items-center no-wrap">
          ...
          <q-btn round dense flat color="white" icon="fab fa-github" type="a" href="https://github.com/lawndoc" target="_blank">
          </q-btn>
          <q-btn round dense flat icon="fas fa-heart" style="color:#9d4182 !important;" type="a" href="https://github.com/sponsors/lawndoc" target="_blank">
          </q-btn>
          <q-btn round flat>
            <q-avatar size="26px">
    ...
    >
      <q-list>
        ...
        <q-item to="/Meets" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="date_range"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>Meets</q-item-label>
          </q-item-section>
        </q-item>

        <q-item to="/Results" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="list"/>
          </q-item-section>
          <q-item-section>
